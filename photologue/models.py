...
class Gallery(models.Model):
    ...
    is_gallerie_bouquets =  models.BooleanField(_('Gallerie des bouquets'), default=True)

    is_gallerie_events = not is_gallerie_bouquets
...
class Photo(ImageModel):
    ...
    prix  = models.CharField(_('prix'), max_length = 6, default = "")
    ...
    is_cover = models.BooleanField(_("Couverture de l'album"), default = False)
